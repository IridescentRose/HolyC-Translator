...
void emit_header(FILE* fp, const char* filename){
    ...
    fprintf(fp, "#define ToU8(x)     (uint8_t)(x)\n");
    fprintf(fp, "#define ToU16(x)    (uint16_t)(x)\n");
    fprintf(fp, "#define ToU32(x)    (uint32_t)(x)\n");
    fprintf(fp, "#define ToU64(x)    (uint64_t)(x)\n");
    fprintf(fp, "#define ToI8(x)     (int8_t)(x)\n");
    fprintf(fp, "#define ToI16(x)    (int16_t)(x)\n");
    fprintf(fp, "#define ToI32(x)    (int32_t)(x)\n");
    fprintf(fp, "#define ToI64(x)    (int64_t)(x)\n");
    fprintf(fp, "#define ToF64(x)    (double)(x)\n\n");
}
